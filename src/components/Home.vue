...
<div class="container mt-5">
    <div class="row text-center">
      <!-- Columna Izquierda -->
      <div class="col-12 col-md-6 form-container d-flex flex-column align-items-start">
        <a href="https://ibb.co/6vjywRD">
          <img src="https://i.ibb.co/tZVHKMY/logopeque.png" alt="logopeque" class="img-fluid mb-3" />
        </a>
        <p class="space">
      ...
      <div class="col-12 col-md-6">
        <div class="row">
          ...
          <div class="col-6 mb-3">
            <img src="https://i.ibb.co/938c8Nk/image-26.png" class="unib" alt="Imagen 1">
          </div>
          <div class="col-6 mb-3">
            <img src="https://i.ibb.co/tzDxkxQ/image-24.png" class="unib" alt="Imagen 2">
          </div>
          <div class="col-6 mb-3">
            <img src="https://i.ibb.co/Sct2p9p/image-22.png" class="unib" alt="Imagen 3">
          </div>
          <div class="col-6 mb-3">
            <img src="https://i.ibb.co/BwxY5Pf/image-25.png" class="unib" alt="Imagen 4">
          </div>
          <div class="col-6 mb-3">
            <img src="https://vuela.org/wp-content/uploads/2020/08/logo-anahuac-mes-dorado.png" class="unib" alt="Imagen 5">
          </div>
          <div class="col-6 mb-3">
            <img src="https://i.ibb.co/rsSh8C8/image-34.png" class="unib" alt="Imagen 6">
          </div>
          <div class="col-6 mb-3">
            <img src="https://universidad.tecmilenio.mx/hubfs/Tecmilenio-Logo-Mobile.png" class="unib" alt="Imagen 1">
          </div>
          <div class="col-6 mb-3">
            <img src="https://lh4.googleusercontent.com/proxy/26j8qGcs_divn1Wm4DWLSnj6MgCdN2OPpY5L-ajBPJI9pVO6-iiaC8erUsmTjVPWhgtM2sV3TFjaPsJxnD4Ik7xKAyBBzQu9YDC-SKHY5Xduyq6DpeNPvjOFEJQizAhqyfJc" class="unib" alt="Imagen 2">
          </div>
          <div class="col-6 mb-3">
            <img src="https://i.ibb.co/938c8Nk/image-26.png" class="unib" alt="Imagen 3">
          </div>
          <div class="col-6 mb-3">
            <img src="https://i.ibb.co/938c8Nk/image-26.png" class="unib" alt="Imagen 4">
          </div>
          <div class="col-6 mb-3">
            <img src="https://i.ibb.co/938c8Nk/image-26.png" class="unib" alt="Imagen 5">
          </div>
          <div class="col-6 mb-3">
            <img src="https://i.ibb.co/938c8Nk/image-26.png" class="unib" alt="Imagen 6">
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="row justify-content-center">
      <div class="col-12 col-md-10">
        <div class="articles d-flex flex-wrap justify-content-center">
          ...
          <article>
            ...
            <div class="article-preview">
              ...
              <p>
                ...
                <a href="https://www.unid.talisis.com/campus/playa-del-carmen">Más información</a>
              </p>
            </div>
          ...
          <article>
            <figure>
              <img src="https://i.pinimg.com/474x/2f/a8/a3/2fa8a343353771439877f642453e02eb.jpg" alt=""
            ...
            <div class="article-preview">
              ...
              <p>
                ...
                <a href="http://www.universidadriviera.edu.mx/">Más información</a>
              </p>
            </div>
          ...
          <article>
            <figure>
              <img src="https://www.emagister.com.mx/assets/mx/logos/centro/id/16855/size/l.jpg" alt=""
                style="background-color: white" />
            </figure>
            <div class="article-preview">
          ...
          <article>
            <figure>
              <img
                src="https://i.redd.it/what-is-the-most-epic-match-battle-you-had-in-aoe-ii-v0-lpqjbc995aub1.jpg?width=1280&format=pjpg&auto=webp&s=3912b4c7653e1a4058d4fa781205794c32d22457"
                alt="" />
            </figure>
            <div class="article-preview">
              ...
              <p>
                ...
                <a href="https://en.wikipedia.org/wiki/Age_of_Empires">Más info aquí ^w^</a>
              </p>
            </div>
    ...
    <div class="resenas d-flex flex-wrap justify-content-center">
      ...
      <article class="separacionr">
        <div class="resenas-comentario">
          ...
          <p>
            ¡Arcanum es justo lo que necesitaba como estudiante! Esta aplicación es una herramienta súper útil para
            quienes queremos conectarnos con otros estudiantes, ya sea para resolver dudas de materias.
            Lo que más me gustó es que está organizada por universidades, así que puedo interactuar con compañeros de mi
            propia institución, pero también con alumnos de otras escuelas.
...
* {
  ...
  /* Fuerza que todos los textos sean blancos */
}
...
.colores3 {
  ...
  flex-shrink: 0;
  border-radius: 20px;
  background: linear-gradient(100deg, #b936f5 -21.45%, #48c57a 100%, #fbf7ff 100%);
...
.resenas article {
  max-width: 320px;
  width: 100%;
  /* Asegura que se adapte a móviles */
  display: block;
  overflow: visible;
  /* Permite que todo el contenido sea visible */
  border-radius: 8px;
  background: #1a1a1a;
...
.resenas h2 {
  font-weight: bold;
  font-size: 20px;
  /* Ajusta el tamaño para evitar desbordes */
  margin-bottom: 15px;
  color: white;
}
